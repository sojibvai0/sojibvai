...
\33[1;37m----------------------------------------------
→   Owner      :  SHAHRIAR AHMED
→   Facebook   :  SHAHRIAR AHMED
→   Github     :  SOJIBVAI0
→   Tool Type  :  \x1b[1;91mPAID
\x1b[1;97m→   Version    :  5.0
\33[1;37m----------------------------------------------""")
def linex():
	print('\33[1;37m----------------------------------------------')
loop = 0
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/ja.aminur');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
...
def bd1():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE : +88017,+88013,+88019,.ETC')
	linex()
	kode = input('[+]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	print(' Example : 3000,5000,10000,****Etc')
	limit = int(input('[+] Put Your Id limit :  '))
